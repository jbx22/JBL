...
export function ProjectExplorer({
    ...
    async function handleDropOnTarget(targetFolderId: string | null, e: React.DragEvent) {
        const docId = e.dataTransfer.getData("application/bizlaw-doc");
        const movingFolderId = e.dataTransfer.getData("application/bizlaw-folder");
    ...
    function isInternalDrag(e: React.DragEvent): boolean {
        return (
            Array.from(e.dataTransfer.types).includes("application/bizlaw-doc") ||
            Array.from(e.dataTransfer.types).includes("application/bizlaw-folder")
        );
    }
